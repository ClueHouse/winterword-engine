...
WW.isCurrentLocation = function(scope, href){
  var location = WW.getLocation(scope);
  if (!location || !href) return false;
  return (String(location.pathname || "") + String(location.search || "")) === String(href);
};
